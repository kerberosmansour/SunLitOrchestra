...
- **Optional arg:** `/slo-sast <slug>` — explicit threat-model slug; resolves to `docs/design/<slug>-threat-model.md`.
...
The skill extracts CWE references from `docs/design/<slug>-threat-model.md` using:
