...
- **Artifact locations.** `SECURITY.md` at the target repo root. `docs/design/<slug>-threat-model.md` per feature. `docs/critique/<slug>.md` unchanged from today's `/slo-critique` shape.
