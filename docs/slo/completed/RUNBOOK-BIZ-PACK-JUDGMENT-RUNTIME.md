...
|---|---|---|---|---|---|---|
| 1 | Harness scaffolding + 1 fixture green | `done` | 2026-04-25 | 2026-04-25 | `docs/slo/lessons/biz-judgment-runtime-m1.md` | `docs/slo/completion/biz-judgment-runtime-m1.md` |
| 2 | Wire all 9 fixtures + retry/cost-cap + docs | `done` | 2026-04-25 | 2026-04-25 | `docs/slo/lessons/biz-judgment-runtime-m2.md` | `docs/slo/completion/biz-judgment-runtime-m2.md` |

<!-- Status values: not_started | in_progress | blocked | done -->
<!-- Lessons files go in docs/slo/lessons/biz-judgment-runtime-m<N>.md -->
<!-- Completion summaries go in docs/slo/completion/biz-judgment-runtime-m<N>.md -->
...
| **Files allowed to change** | `crates/sldo-install/tests/e2e_biz_judgment_runtime_m1.rs` (new); `crates/sldo-install/tests/common/judgment_runtime.rs` (new); `crates/sldo-install/tests/common/mod.rs` (new); `docs/slo/completed/RUNBOOK-BIZ-PACK-JUDGMENT-RUNTIME.md` (this file, tracker only) |
...
| `docs/slo/completed/RUNBOOK-BIZ-PACK-JUDGMENT-RUNTIME.md` | edit (tracker only) | Mark M1 in_progress / done |
...
- [ ] Lessons file written: `docs/slo/lessons/biz-judgment-runtime-m1.md`.
- [ ] Completion summary written: `docs/slo/completion/biz-judgment-runtime-m1.md`.
- [ ] Tracker updated.
...
| `docs/slo/completed/RUNBOOK-BIZ-PACK-JUDGMENT-RUNTIME.md` | edit (tracker only) | Mark M2 in_progress / done |
...
- M1 lessons: `docs/slo/lessons/biz-judgment-runtime-m1.md`
- M2 lessons: `docs/slo/lessons/biz-judgment-runtime-m2.md`
- M1 completion: `docs/slo/completion/biz-judgment-runtime-m1.md`
- M2 completion: `docs/slo/completion/biz-judgment-runtime-m2.md`
