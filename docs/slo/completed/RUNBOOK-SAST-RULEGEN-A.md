...
> **Prerequisite reading**: [docs/ARCHITECTURE.md](ARCHITECTURE.md), [SECURITY.md](../SECURITY.md), [docs/slo/idea/sast-rulegen-skill-pack.md](idea/sast-rulegen-skill-pack.md), [docs/slo/research/sast-rulegen-skill-pack/synthesis.md](research/sast-rulegen-skill-pack/synthesis.md), [docs/slo/design/sast-rulegen-skill-pack-overview.md](design/sast-rulegen-skill-pack-overview.md), [docs/slo/design/sast-rulegen-skill-pack-stack-decision.md](design/sast-rulegen-skill-pack-stack-decision.md), [docs/slo/design/sast-rulegen-skill-pack-interfaces.md](design/sast-rulegen-skill-pack-interfaces.md), [docs/slo/design/sast-rulegen-skill-pack-threat-model.md](design/sast-rulegen-skill-pack-threat-model.md)
...
- **Public interfaces that must remain stable unless explicitly listed otherwise** (cited from [docs/slo/design/sast-rulegen-skill-pack-interfaces.md](design/sast-rulegen-skill-pack-interfaces.md)):
...
|---|---|---|---|---|---|---|
| 1 | Bootstrap pack + verifier gate (`sast-verify` xtask, top-10 CWE rules, paired corpus) | `done` (10/10 rules — M1 shipped CWE-755/190/295; M1.5 added CWE-697/20/79; M1.6 added CWE-787/125/416/672 via `pattern + pattern-inside fn-body-with-precondition` rather than the originally-recommended taint mode) | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/sast-rulegen-a-m1.md](lessons/sast-rulegen-a-m1.md), [docs/slo/lessons/sast-rulegen-a-m1.6.md](lessons/sast-rulegen-a-m1.6.md) | [docs/slo/completion/sast-rulegen-a-m1.md](completion/sast-rulegen-a-m1.md), [docs/slo/completion/sast-rulegen-a-m1.6.md](completion/sast-rulegen-a-m1.6.md) |
| 2 | Extend-mode (`/slo-rulegen --extend` from `(bug, fix_diff)` to 3–5 variation rules) | `done` (extend-mode prompt + skill contract + 7 disk-content E2E tests; runtime BDD deferred to /slo-verify Pass 4) | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/sast-rulegen-a-m2.md](lessons/sast-rulegen-a-m2.md) | [docs/slo/completion/sast-rulegen-a-m2.md](completion/sast-rulegen-a-m2.md) |
| 3 | CI + dev-env wiring (GitHub Action, pre-commit hook, LICENSE, cargo-audit-driven extend trigger) | `done` (workflow YAML + pre-commit config + LICENSE + README SAST section + CI-WIRING.md; 8 disk-content E2E tests; semgrep-action SHA placeholder with documented re-pin path in M3.5) | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/sast-rulegen-a-m3.md](lessons/sast-rulegen-a-m3.md) | [docs/slo/completion/sast-rulegen-a-m3.md](completion/sast-rulegen-a-m3.md) |

<!-- Status values: not_started | in_progress | blocked | done -->
<!-- Lessons files go in docs/slo/lessons/sast-rulegen-a-m<N>.md -->
<!-- Completion summaries go in docs/slo/completion/sast-rulegen-a-m<N>.md -->
...
11. Write a lessons-learned file at `docs/slo/lessons/sast-rulegen-a-m<N>.md`.
12. Write a completion summary at `docs/slo/completion/sast-rulegen-a-m<N>.md`.
...
Path: `docs/slo/lessons/sast-rulegen-a-m<N>.md`
...
Path: `docs/slo/completion/sast-rulegen-a-m<N>.md`
...
| Files allowed to change | `Cargo.toml` (workspace), `CLAUDE.md`, `crates/sldo-common/src/toolflags.rs`, `.gitignore`, `docs/ARCHITECTURE.md` (post-implementation reality update only — not pre-staged content), `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` (Milestone Tracker only) |
| Files to read before changing anything | [docs/slo/idea/sast-rulegen-skill-pack.md](idea/sast-rulegen-skill-pack.md), [docs/slo/research/sast-rulegen-skill-pack/synthesis.md](research/sast-rulegen-skill-pack/synthesis.md), [docs/slo/design/sast-rulegen-skill-pack-overview.md](design/sast-rulegen-skill-pack-overview.md), [docs/slo/design/sast-rulegen-skill-pack-stack-decision.md](design/sast-rulegen-skill-pack-stack-decision.md), [docs/slo/design/sast-rulegen-skill-pack-interfaces.md](design/sast-rulegen-skill-pack-interfaces.md), [docs/slo/design/sast-rulegen-skill-pack-threat-model.md](design/sast-rulegen-skill-pack-threat-model.md), [SECURITY.md](../SECURITY.md), `crates/sldo-common/src/toolflags.rs` (existing pattern), `crates/sldo-research/src/main.rs` (clap derive precedent), `crates/sldo-tla-sha/src/lib.rs` (subprocess invocation precedent), `references/biz/` directory (shared-scaffolding precedent), [docs/slo/templates/runbook-template_v_3_template.md](runbook-template_v_3_template.md) |
...
2. No previous milestone — skip `docs/slo/lessons/sast-rulegen-a-m0.md`.
...
| `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` (this file) | Update Milestone Tracker M1 row to `done` with completion date |
...
| Files allowed to change | `skills/slo-rulegen/SKILL.md` (add extend-mode section), `references/sast/prompts/extend.md` (fill body authored as skeleton in M1), `xtasks/sast-verify/src/main.rs` (add `detect-tier` subcommand if not in M1), `xtasks/sast-verify/src/tier_detect.rs` (NEW), `xtasks/sast-verify/tests/tier_detect_test.rs` (NEW), `tests/e2e_sast_rulegen_a_m2.rs` (NEW), `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` (Milestone Tracker M2) |
| Files to read before changing anything | All M1 files in `xtasks/sast-verify/`, all of `references/sast/`, `skills/slo-rulegen/SKILL.md` (M1), [docs/slo/lessons/sast-rulegen-a-m1.md](lessons/sast-rulegen-a-m1.md), [docs/slo/design/sast-rulegen-skill-pack-threat-model.md](design/sast-rulegen-skill-pack-threat-model.md) Surface 1 abuse cases |
...
1. Complete the Global Entry Rules.
2. Read `docs/slo/lessons/sast-rulegen-a-m1.md` and apply relevant corrections.
...
| `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` | Milestone Tracker M2 row |
...
| Files allowed to change | `.github/workflows/semgrep.yml` (NEW), `.pre-commit-config.yaml` (NEW), `references/sast/CI-WIRING.md` (NEW), `LICENSE` (NEW), `README.md`, `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` (Milestone Tracker M3), `tests/e2e_sast_rulegen_a_m3.rs` (NEW) |
| Files to read before changing anything | All M1 + M2 deliverables, [SECURITY.md](../SECURITY.md) "SAST rule-gen skill pack — additional rules" especially the LICENSE addendum, [docs/slo/lessons/sast-rulegen-a-m{1,2}.md](lessons/), `.github/workflows/` directory (existing CI patterns to mirror), the README's current shape |
...
1. Complete the Global Entry Rules.
2. Read `docs/slo/lessons/sast-rulegen-a-m2.md` and apply relevant corrections.
3. Read the allowed files before editing.
4. Copy the Evidence Log template into this milestone section.
5. Re-state the milestone constraints before coding.
...
| `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` | Milestone Tracker M3 row to `done` |
...
|---|---|---|---|---|
| 1 | Reality-check the pre-staged `slo-rulegen`, `slo-ruleverify`, `xtasks/sast-verify`, `references/sast/` bullets — confirm/correct against what shipped | (none) | Add `.semgrep/.scratch/`, `xtasks/sast-verify/tests/scratch/` | `references/sast/` directory authored in full; `CLAUDE.md` baseline test command appended `-p sast-verify`; `docs/slo/lessons/sast-rulegen-a-m1.md`; `docs/slo/completion/sast-rulegen-a-m1.md` |
| 2 | Update `slo-rulegen` bullet to mention `--extend` mode; add `detect-tier` subcommand if landed | (none) | Confirm `.semgrep/.scratch/` covers the Confidential tier | `docs/slo/lessons/sast-rulegen-a-m2.md`; `docs/slo/completion/sast-rulegen-a-m2.md`; `references/sast/prompts/extend.md` filled |
| 3 | Document `.github/workflows/semgrep.yml` and `.pre-commit-config.yaml` as shipped CI / dev-env surfaces; mark the SAST pack as no-longer-DESIGN | NEW: "SAST rule pack" section added | (any CI-specific entries) | `LICENSE` (NEW); `references/sast/CI-WIRING.md` (NEW); `docs/slo/lessons/sast-rulegen-a-m3.md`; `docs/slo/completion/sast-rulegen-a-m3.md`; SECURITY.md LICENSE-addendum confirmed acted on |
