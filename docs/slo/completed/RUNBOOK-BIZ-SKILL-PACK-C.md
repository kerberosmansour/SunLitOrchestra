...
|---|---|---|---|---|---|---|
| 1 | `/slo-cofounder` (eval checklist + trial-project framing + monthly 1:1 agenda) | `done` | 2026-04-25 | 2026-04-25 | per-milestone files in [docs/slo/lessons/](lessons/) and [docs/slo/completion/](completion/) | |
| 2 | `/slo-hire` (sourcing playbook with role-shape mode arg + IR35 triage gate) | `done` | 2026-04-25 | 2026-04-25 | per-milestone files in [docs/slo/lessons/](lessons/) and [docs/slo/completion/](completion/) | |
| 3 | `/slo-founder-check` (self-assessment + worst-case-runway worksheet + YC application prep) | `done` | 2026-04-25 | 2026-04-25 | per-milestone files in [docs/slo/lessons/](lessons/) and [docs/slo/completion/](completion/) | |
