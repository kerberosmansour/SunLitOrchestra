...
- **Public interfaces that must remain stable unless explicitly listed otherwise**:
  - `docs/slo/templates/runbook-template_v_3_template.md` section schema (additive only)
  - `docs/slo/lessons/<prefix>-m<N>.md` template
...
|---|---|---|---|---|---|---|
| 1 | LOOPS-ENGINEERING.md authored + cross-linked | `done` | 2026-04-30 | 2026-04-30 | [docs/slo/lessons/loops-m1.md](lessons/loops-m1.md) | [docs/slo/completion/loops-m1.md](completion/loops-m1.md) |
| 2 | LOOPS-BUSINESS.md authored + cross-linked | `done` | 2026-04-30 | 2026-04-30 | [docs/slo/lessons/loops-m2.md](lessons/loops-m2.md) | [docs/slo/completion/loops-m2.md](completion/loops-m2.md) |
| 3 | `/slo-retro` extension: classify, dedupe, file lessons as issues | `done` | 2026-04-30 | 2026-04-30 | [docs/slo/lessons/loops-m3.md](lessons/loops-m3.md) | [docs/slo/completion/loops-m3.md](completion/loops-m3.md) |
| 4 | `/slo-execute` pre-flight loop closure + runbook template "Carry-forward from prior retros" section with suggested lane | `done` | 2026-04-30 | 2026-04-30 | [docs/slo/lessons/loops-m4.md](lessons/loops-m4.md) | [docs/slo/completion/loops-m4.md](completion/loops-m4.md) |
| 5 | `/slo-resume` next-step digest + lane-aware orientation | `done` | 2026-04-30 | 2026-04-30 | [docs/slo/lessons/loops-m5.md](lessons/loops-m5.md) | [docs/slo/completion/loops-m5.md](completion/loops-m5.md) |
...
│                                                                  │        │
│  ┌────────────────┐         ┌──────────────────────┐             │        │
│  │ /slo-retro M<N>│ ────▶   │  docs/slo/lessons/       │             │        │
...
| `docs/slo/templates/runbook-template_v_3_template.md` | New optional "Carry-forward from prior retros" section with suggested lane | M4 EXTENDED | Read by `/slo-plan` and `/slo-resume` |
...
- Read [`docs/slo/design/loops-and-lessons-closure-overview.md`](design/loops-and-lessons-closure-overview.md) before M1.
...
The SLO skill pack has 32 SKILL.md files, 7 reference subtrees under `references/`, 5+ active runbooks under `docs/RUNBOOK-*.md`, and an established lessons-file pattern at `docs/slo/lessons/<prefix>-m<N>.md`. [`/slo-retro`](../skills/slo-retro/SKILL.md) writes the lessons file at milestone close; [`/slo-execute`](../skills/slo-execute/SKILL.md) reads the *previous* milestone's lessons at pre-flight (a single-step look-back, not a queued backlog).
...
2. **Lateral dropout in upstream signal**: When `/slo-execute` discovers a bug in an upstream tool, the lesson sits in a markdown file. The library-feedback loop dies in a local file. Concrete: a Semgrep CLI flag deprecation was noted in `docs/slo/lessons/slo-sec-m4.md` but never filed against the Semgrep repo.
...
- Existing [`docs/slo/lessons/<prefix>-m<N>.md`](lessons/) template (additive changes only).
...
- **`docs/slo/templates/runbook-template_v_3_template.md`** — add optional "Carry-forward from prior retros" section with suggested lane (M4).
...
- abuse case (per-milestone — see threat-model rows in [`docs/slo/design/loops-and-lessons-closure-overview.md`](design/loops-and-lessons-closure-overview.md))
...
See template (`docs/slo/lessons/loops-m<N>.md`).

---

## Completion Summary Template

See template (`docs/slo/completion/loops-m<N>.md`).
...
| Files to read before changing anything | All engineering SKILL.md files; `docs/slo/design/scanner-orchestration-overview.md` (for diagram style); Issue #17 |
...
| Field | Value |
|---|---|
| Inputs | `/slo-retro`-completed lessons file at `docs/slo/lessons/<prefix>-m<N>.md`; runbook prefix; `gh` CLI availability; user confirmation for each filing |
...
| Issue body contains a markdown reference cycle | abuse case (`tm-loops-abuse-3e`) | lesson body cites `docs/slo/lessons/<this-milestone>.md` (self-reference) | filer detects self-reference; rewrites as `<this milestone, see runbook tracker>` | no infinite recursion when M4 carry-forward reads it back |
...
| Interfaces touched | `/slo-execute` SKILL.md pre-flight section (additive); `docs/slo/templates/runbook-template_v_3_template.md` (additive section with lane column) |
| Files allowed to change | `skills/slo-execute/SKILL.md`, `docs/slo/templates/runbook-template_v_3_template.md`, `crates/sldo-install/tests/e2e_loops_m4.rs` (new) |
| Files to read before changing anything | `skills/slo-execute/SKILL.md` current pre-flight; M3's `references/issue-filing-discipline.md` (for marker choice); `docs/slo/templates/runbook-template_v_3_template.md` |
...
4. Read [`docs/slo/templates/runbook-template_v_3_template.md`](runbook-template_v_3_template.md) end-to-end.
...
| `docs/slo/templates/runbook-template_v_3_template.md` | Add new optional section "## Carry-forward from prior retros" between "Background Context" and "BDD and Runtime Validation Rules". Schema: per-row issue # + title + suggested lane (`micro | milestone | fresh-runbook`) + suggested milestone column. |
...
| Files allowed to change | `skills/slo-resume/SKILL.md`, `crates/sldo-install/tests/e2e_loops_m5.rs` (new), `docs/slo/completed/RUNBOOK-LOOPS-AND-LESSONS-CLOSURE.md` (tracker + carry-forward dogfood row updates only) |
| Files to read before changing anything | `skills/slo-resume/SKILL.md` current behavior; M4-updated `docs/slo/templates/runbook-template_v_3_template.md`; this runbook's new carry-forward section shape |
...
3. Read the M4-updated carry-forward section schema in [`docs/slo/templates/runbook-template_v_3_template.md`](runbook-template_v_3_template.md).
...
| 4 | Note `/slo-execute` pre-flight loop closure | optional | none | `docs/slo/templates/runbook-template_v_3_template.md` (new section + lane column) |
