...
> **Prerequisite reading**: [docs/slo/completed/RUNBOOK-BIZ-SKILL-PACK-A.md](RUNBOOK-BIZ-SKILL-PACK-A.md) (now merged), [docs/slo/design/biz-skill-pack-overview.md](design/biz-skill-pack-overview.md), [docs/slo/design/biz-skill-pack-interfaces.md](design/biz-skill-pack-interfaces.md), [docs/slo/design/biz-skill-pack-threat-model.md](design/biz-skill-pack-threat-model.md), [SECURITY.md](../SECURITY.md) (root, biz section), [references/biz/artifact-schema.md](../references/biz/artifact-schema.md).
...
|---|---|---|---|---|---|---|
| 1 | `/slo-talk-to-users` + deferred `/slo-verify` Pass 4 PII-pattern scan integration | `done` | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/biz-b1-m1.md](lessons/biz-b1-m1.md) | [docs/slo/completion/biz-b1-m1.md](completion/biz-b1-m1.md) |
| 2 | `/slo-gtm` (ICP / segmentation / motion choice / channel strategy) | `done` | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/biz-b1-m2.md](lessons/biz-b1-m2.md) | [docs/slo/completion/biz-b1-m2.md](completion/biz-b1-m2.md) |
| 3 | `/slo-product` (mode arg: roadmap \| metrics \| okrs; north-star metric, activation funnel, retention, RICE/Kano prioritisation) | `done` | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/biz-b1-m3.md](lessons/biz-b1-m3.md) | [docs/slo/completion/biz-b1-m3.md](completion/biz-b1-m3.md) |
| 4 | `/slo-marketing` (mode arg: b2b \| b2c; brand voice, content calendar, channel mix, demand gen) | `done` | 2026-04-25 | 2026-04-25 | [docs/slo/lessons/biz-b1-m4.md](lessons/biz-b1-m4.md) | [docs/slo/completion/biz-b1-m4.md](completion/biz-b1-m4.md) |

---

## End-to-End Architecture Diagram

See [docs/slo/design/biz-skill-pack-overview.md](design/biz-skill-pack-overview.md) for the full diagram. Runbook B1 fills the "Discovery → Strategy → Definition" cluster of the pack diagram. Solid lines exist after Runbook A merge; dashed lines added by this runbook.
...
| Outputs | NEW: `skills/slo-talk-to-users/SKILL.md`, `crates/sldo-install/tests/e2e_biz_b1_m1.rs`, `docs/slo/verify/biz-b1-m1-smoke.md`. EDITED: `skills/slo-verify/SKILL.md` (Pass 4 sub-step), `references/biz/artifact-schema.md` (add `archetype` and optional `mode_arg` keys). |
...
| Files allowed to change | `skills/slo-talk-to-users/SKILL.md` (NEW); `skills/slo-verify/SKILL.md` (small additive edit); `references/biz/artifact-schema.md` (small additive edit); `crates/sldo-install/tests/e2e_biz_b1_m1.rs` (NEW); `docs/slo/verify/biz-b1-m1-smoke.md` (NEW); `docs/ARCHITECTURE.md` (one-line). |
...
6. Author `docs/slo/verify/biz-b1-m1-smoke.md` with 4 fixtures.
...
**Files (NEW)**: `skills/slo-gtm/SKILL.md`, `crates/sldo-install/tests/e2e_biz_b1_m2.rs`, `docs/slo/verify/biz-b1-m2-smoke.md`. ARCHITECTURE.md +1 row.
...
**Files (NEW)**: `skills/slo-product/SKILL.md`, `crates/sldo-install/tests/e2e_biz_b1_m3.rs`, `docs/slo/verify/biz-b1-m3-smoke.md`. ARCHITECTURE.md +1 row.
...
**Files (NEW)**: `skills/slo-marketing/SKILL.md`, `crates/sldo-install/tests/e2e_biz_b1_m4.rs`, `docs/slo/verify/biz-b1-m4-smoke.md`. CLAUDE.md edit (single — extends biz catalog with B1 generators).
