...
| `docs/slo/verify/biz-a-m2-smoke.md` | Manual smoke checklist with 6 fixtures | ~80 |
...
- ✅ `crates/sldo-install/src/install.rs`, `docs/slo/templates/runbook-template_v_3_template.md`, `crates/sldo-tauri/`, `SECURITY.md` (root) all unchanged.
...
[M3 — `/slo-equity` + `references/biz/hmrc-vcm-index.md`](../completed/RUNBOOK-BIZ-SKILL-PACK-A.md#milestone-3--slo-equity--referencesbizhmrc-vcm-indexmd). M3 follows M2's pattern (third advisor + new shared reference); cross-skill citation test extends to assert three advisor SKILL.mds cite all four predicates.
