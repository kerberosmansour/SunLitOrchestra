...
- `docs/slo/completed/RUNBOOK-SCANNER-ORCHESTRATION.md` — modified (Milestone Tracker M1 → done; M1 Evidence Log filled; ENG-7 auto-fix applied earlier)
- `docs/slo/lessons/scanner-orch-m1.md` — NEW
- `docs/slo/completion/scanner-orch-m1.md` — NEW (this file)
...
- `docs/slo/completed/RUNBOOK-SCANNER-ORCHESTRATION.md` — Milestone Tracker row 1 → `done`; M1 Evidence Log fully populated.
