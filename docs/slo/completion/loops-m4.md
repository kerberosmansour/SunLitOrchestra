...
- `docs/slo/templates/runbook-template_v_3_template.md` — added new optional "## Carry-forward from prior retros" section between "Background Context" and "BDD and Runtime Validation Rules".
- `docs/slo/completed/RUNBOOK-LOOPS-AND-LESSONS-CLOSURE.md` — Milestone Tracker row 4 updated to `done`; "Carry-forward from prior retros" placeholder section updated as dogfood.
...
- `docs/slo/lessons/loops-m4.md` (new)
- `docs/slo/completion/loops-m4.md` (new)
...
- `docs/slo/templates/runbook-template_v_3_template.md` — new optional section.
- `docs/slo/completed/RUNBOOK-LOOPS-AND-LESSONS-CLOSURE.md` — dogfood carry-forward section row.
