...
**Runbook**: [docs/slo/completed/RUNBOOK-BIZ-SKILL-PACK-A.md](../completed/RUNBOOK-BIZ-SKILL-PACK-A.md) Milestone 1.
...
| `docs/slo/verify/biz-a-m1-smoke.md` | Manual smoke-test checklist for runtime verification (5 fixtures + edge cases) | ~80 |
...
[M2 — `/slo-accounting` + 5 M2-tier shared references](../completed/RUNBOOK-BIZ-SKILL-PACK-A.md#milestone-2--slo-accounting--m2-tier-shared-references). M2 proves the advisor pattern replicates by reusing M1's `triage-gate.md` predicates without modification (cross-skill citation structural test).
