...
- `docs/slo/completed/RUNBOOK-SCANNER-ORCHESTRATION.md` — modified (M2 asks ENG-2/ENG-5/ENG-8/CEO-1/SEC-2/SEC-6 applied; Milestone Tracker M2 → done)
- `docs/slo/lessons/scanner-orch-m2.md` — NEW
- `docs/slo/completion/scanner-orch-m2.md` — NEW (this file)
...
- `docs/slo/completed/RUNBOOK-SCANNER-ORCHESTRATION.md` — Milestone Tracker row 2 → `done`. M2 Evidence Log to be filled by automation or the user; manual entries follow the M1 pattern.
