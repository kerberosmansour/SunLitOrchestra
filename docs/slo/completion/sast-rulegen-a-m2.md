...
- `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` — Milestone Tracker M2 → done
...
- `docs/slo/lessons/sast-rulegen-a-m2.md` (this milestone) — written
- `docs/slo/completion/sast-rulegen-a-m2.md` (this file) — written
