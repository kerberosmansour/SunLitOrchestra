...
- `docs/slo/completed/RUNBOOK-SLO-SECURITY-EMBEDDING.md` (Milestone Tracker + M2 Evidence Log filled)
...
- 1 template FNV-1a invariant (proves `docs/slo/templates/runbook-template_v_3_template.md` unmodified during M2)
...
- `docs/slo/templates/runbook-template_v_3_template.md` byte-identical (FNV-1a `0x5c2f04635249e0a2`, 29978 bytes — invariant verified by test).
...
- Bump `docs/slo/templates/runbook-template_v_3_template.md` to include the three new rows as a pre-filled example. Would require a schema migration contract; deferred.
