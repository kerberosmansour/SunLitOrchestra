...
- `docs/slo/completion/sast-rulegen-a-m1.5-m3.5.md` (this file)

## NOT changed

- `docs/slo/completed/RUNBOOK-SAST-RULEGEN-A.md` — the M1 tracker row already noted "3/10 rules — remaining 7 deferred to M1.5 with all variation templates already in place." This cleanup PR delivers 3 of those 7; M1.6 is the follow-up for the final 4. The tracker row stays accurate without further edit.
