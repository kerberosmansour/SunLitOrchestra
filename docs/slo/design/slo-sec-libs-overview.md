...
|---|---|---|---|
| `skills/slo-sec-libs/SKILL.md` | Skill orchestrator; mode dispatch; pre-flight | M1-M5 | Reads target repo's `ARCHITECTURE.md`, `docs/slo/design/<slug>-stack-decision.md`, `docs/RUNBOOK-<slug>.md` |
...
New abuse cases (extends `docs/slo/design/slo-security-embedding-threat-model.md`):
