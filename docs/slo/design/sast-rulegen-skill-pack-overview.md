...
- `docs/slo/idea/sast-rulegen-skill-pack.md` — pain, capabilities, top-3 risks, three approaches, recommendation (Approach C, Runbook A 3-milestone shape).
- `docs/slo/research/sast-rulegen-skill-pack/dossier.md` — competitor table, adjacent-tools decisions, prior-art references.
- `docs/slo/research/sast-rulegen-skill-pack/synthesis.md` — load-bearing design rules ("the design must handle X because <source>").
...
- [docs/slo/design/sast-rulegen-skill-pack-stack-decision.md](sast-rulegen-skill-pack-stack-decision.md) — chosen stack with rejected alternatives.
- [docs/slo/design/sast-rulegen-skill-pack-interfaces.md](sast-rulegen-skill-pack-interfaces.md) — public-API stability contract for downstream milestones.
...
- [docs/slo/design/sast-rulegen-skill-pack-threat-model.md](sast-rulegen-skill-pack-threat-model.md) — STRIDE per component + abuse cases + compliance + AI/LLM threats.
- This file.
