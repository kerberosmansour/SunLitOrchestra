...
- [ ] Skill REFUSES to draft.
- [ ] Skill emits the canonical error "v1 supports UK only; US/EU is a v2 architectural pivot — see [docs/slo/design/biz-skill-pack-overview.md](../design/biz-skill-pack-overview.md) ...".
