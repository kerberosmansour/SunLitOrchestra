...
3. **Loop diagram format** ([#17](https://github.com/kerberosmansour/SunLitOrchestrate/issues/17), [#18](https://github.com/kerberosmansour/SunLitOrchestrate/issues/18) Q2): ASCII vs Mermaid. Lean: match the closest existing design doc — likely `docs/slo/design/scanner-orchestration-overview.md` — at runbook-author time.
