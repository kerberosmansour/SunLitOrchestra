...
note: |
  ...
  slo-security-embedding program. See `docs/slo/research/slo-security-embedding/dossier.md`
  and `docs/slo/research/slo-security-embedding/synthesis.md` for the upstream research
