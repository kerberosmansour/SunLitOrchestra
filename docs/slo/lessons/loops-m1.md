...
- ASCII box-drawing diagrams over Mermaid — matches the existing `docs/slo/design/scanner-orchestration-overview.md` style; renders identically in GitHub web + terminal without a JS pass.
