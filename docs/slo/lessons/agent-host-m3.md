...
- Living docs (`README.md`, `CLAUDE.md`, `copilot-instructions.md`, `docs/skill-pack-catalog.md`, `docs/ARCHITECTURE.md`, `docs/getting-started.md`, `docs/slo/design/agent-host-capabilities.md`) align on the same split.
...
- New manual smoke checklist `docs/slo/verify/agent-host-m3-smoke.md` covers both the Claude session and the GitHub Copilot session.
...
- A separate manual smoke checklist file (`docs/slo/verify/agent-host-m<N>-smoke.md`) for things automation cannot verify, with explicit per-host sections.
