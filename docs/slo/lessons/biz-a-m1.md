...
- **NEW** `docs/slo/verify/biz-a-m1-smoke.md` — manual smoke-test checklist for runtime verification of the skill against five fixtures.
...
- **UPDATED** `docs/slo/completed/RUNBOOK-BIZ-SKILL-PACK-A.md` Milestone Tracker — M1 status `done`.
