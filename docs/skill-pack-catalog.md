...
- Every new feature runbook lives at `docs/RUNBOOK-<FEATURE>.md` and follows `docs/runbook-template_v_4_template.md` (v3 remains in place as the historical artifact for runbooks already authored against it).
