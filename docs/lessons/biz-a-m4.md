...
- **NEW** `docs/verify/biz-a-m4-smoke.md` — manual smoke checklist with 7 fixtures + cross-skill consistency + final pack-level verification.
...
- **UPDATED** `docs/RUNBOOK-BIZ-SKILL-PACK-A.md` Milestone Tracker — M4 status `done`.
...
- The biz pack ships ~15 new files across `skills/slo-{legal,accounting,equity,fundraise}/`, `references/biz/`, `crates/sldo-install/tests/`, `docs/verify/`, `docs/lessons/`, `docs/completion/`, plus CLAUDE.md + ARCHITECTURE.md updates.
