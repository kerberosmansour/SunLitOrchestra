...
- **Author extend-mode prompt body in `references/sast/prompts/extend.md`** — the M1 skeleton needs filling. The contract is in `docs/design/sast-rulegen-skill-pack-interfaces.md` §4.
