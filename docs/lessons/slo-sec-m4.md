...
- `docs/runbook-template_v_3_template.md` Evidence Log row set could include a "Baseline regression re-check" row to reinforce the M3 lesson (always run the full baseline after any edit). Deferred.
