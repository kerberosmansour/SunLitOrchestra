...
- `docs/lessons/sast-rulegen-a-m1.6.md`
- `docs/completion/sast-rulegen-a-m1.6.md` (this file)

## Files edited

- `docs/RUNBOOK-SAST-RULEGEN-A.md` — M1 tracker row updated from "3/10" → "10/10" with M1.5 + M1.6 attribution.
