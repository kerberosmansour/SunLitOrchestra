...
- `docs/verify/biz-a-m3-smoke.md` (~25 lines)
...
[M4 — `/slo-fundraise` + `references/biz/ir35-cest-factors.md` + CLAUDE.md catalog edit](../RUNBOOK-BIZ-SKILL-PACK-A.md#milestone-4--slo-fundraise--referencesbizir35-cest-factorsmd). Final milestone of Runbook A; also closes the runbook with the single CLAUDE.md edit cataloging all four advisor skills.
