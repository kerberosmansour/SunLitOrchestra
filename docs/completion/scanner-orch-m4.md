...
- `docs/RUNBOOK-SCANNER-ORCHESTRATION.md` — modified (M4 asks ENG-3 + SEC-1-variant applied; Tracker M4 → done)
- `docs/lessons/scanner-orch-m4.md` — NEW
- `docs/completion/scanner-orch-m4.md` — NEW (this file)
...
- `docs/RUNBOOK-SCANNER-ORCHESTRATION.md` — Milestone Tracker row 4 → `done`.
