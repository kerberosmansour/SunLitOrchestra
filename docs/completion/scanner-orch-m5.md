...
- `docs/RUNBOOK-SCANNER-ORCHESTRATION.md` — modified (M5 asks ENG-4 / ENG-6 / SEC-6 / SEC-8 applied; Tracker M5 → done; runbook now fully complete with all 5 milestones marked done)
- `docs/lessons/scanner-orch-m5.md` — NEW
- `docs/completion/scanner-orch-m5.md` — NEW (this file)
