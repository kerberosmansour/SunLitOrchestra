...
- `docs/verify/biz-a-m4-smoke.md` (~30 lines)
...
- `docs/verify/biz-a-m1-smoke.md`
- `docs/verify/biz-a-m2-smoke.md`
- `docs/verify/biz-a-m3-smoke.md`
- `docs/verify/biz-a-m4-smoke.md`

### Lessons + completion files (8)

- `docs/lessons/biz-a-m{1,2,3,4}.md`
- `docs/completion/biz-a-m{1,2,3,4}.md`
