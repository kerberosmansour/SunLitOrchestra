...
- `docs/RUNBOOK-LOOPS-AND-LESSONS-CLOSURE.md` — Milestone Tracker row updated to `done`.
- `docs/lessons/loops-m3.md` (new)
- `docs/completion/loops-m3.md` (new)
...
- Existing lessons-file write (`docs/lessons/<prefix>-m<N>.md`) happens BEFORE any `gh` call.
