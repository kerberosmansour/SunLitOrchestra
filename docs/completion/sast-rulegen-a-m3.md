...
- `docs/RUNBOOK-SAST-RULEGEN-A.md` — Milestone Tracker M3 → done
...
- `docs/lessons/sast-rulegen-a-m3.md` (this milestone) — written
- `docs/completion/sast-rulegen-a-m3.md` (this file) — written
