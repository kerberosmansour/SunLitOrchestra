...
|---|---|---|---|---|---|---|
| 1 | Bootstrap pack + verifier gate (`sast-verify` xtask, top-10 CWE rules, paired corpus) | `done` (10/10 rules — M1 shipped CWE-755/190/295; M1.5 added CWE-697/20/79; M1.6 added CWE-787/125/416/672 via `pattern + pattern-inside fn-body-with-precondition` rather than the originally-recommended taint mode) | 2026-04-25 | 2026-04-25 | [docs/lessons/sast-rulegen-a-m1.md](lessons/sast-rulegen-a-m1.md), [docs/lessons/sast-rulegen-a-m1.6.md](lessons/sast-rulegen-a-m1.6.md) | [docs/completion/sast-rulegen-a-m1.md](completion/sast-rulegen-a-m1.md), [docs/completion/sast-rulegen-a-m1.6.md](completion/sast-rulegen-a-m1.6.md) |
