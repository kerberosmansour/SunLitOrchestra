---
topic: # Research brief — scanner-orchestration  ## Wedge (one sentence)  A pure-Markdown Claude Code skill (`/slo-sast`) that reads a project's `docs/design/<slug>-threat-model.md`, extracts the named CWE l…
