...
> **Prerequisite reading**: [docs/RUNBOOK-BIZ-SKILL-PACK-A.md](RUNBOOK-BIZ-SKILL-PACK-A.md), [docs/RUNBOOK-BIZ-SKILL-PACK-B1.md](RUNBOOK-BIZ-SKILL-PACK-B1.md), [docs/design/biz-skill-pack-overview.md](design/biz-skill-pack-overview.md).
...
|---|---|---|---|---|---|---|
| 1 | `/slo-launch` (one-shot launch sequence: pitch validator, silent → F&F → communities → press) | `done` | 2026-04-25 | 2026-04-25 | (per-milestone files in [docs/lessons/](lessons/) and [docs/completion/](completion/)) | |
| 2 | `/slo-sales-funnel` (funnel math, cold-email template, deal structure) | `done` | 2026-04-25 | 2026-04-25 | (per-milestone files in [docs/lessons/](lessons/) and [docs/completion/](completion/)) | |
| 3 | `/slo-pricing` (value equation, tier model, "increase by 50%" experiment framing) | `done` | 2026-04-25 | 2026-04-25 | (per-milestone files in [docs/lessons/](lessons/) and [docs/completion/](completion/)) | |
| 4 | `/slo-metrics` (financial KPI dashboard, mode arg consumer \| b2b) | `done` | 2026-04-25 | 2026-04-25 | (per-milestone files in [docs/lessons/](lessons/) and [docs/completion/](completion/)) | |
