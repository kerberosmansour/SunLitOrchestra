...
- **Canonical planning artifact.** Every new feature runbook is `docs/slo/current/RUNBOOK-<FEATURE>.md` and follows `docs/slo/templates/runbook-template_v_4_template.md` (v3 remains in place as the historical artifact for runbooks authored against it).
