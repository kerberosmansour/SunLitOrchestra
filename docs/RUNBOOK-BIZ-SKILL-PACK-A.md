...
> **Prerequisite reading**: [docs/ARCHITECTURE.md](ARCHITECTURE.md), [docs/idea/biz-skill-pack.md](idea/biz-skill-pack.md), [docs/research/biz-skill-pack/synthesis.md](research/biz-skill-pack/synthesis.md), [docs/design/biz-skill-pack-overview.md](design/biz-skill-pack-overview.md), [docs/design/biz-skill-pack-stack-decision.md](design/biz-skill-pack-stack-decision.md), [docs/design/biz-skill-pack-interfaces.md](design/biz-skill-pack-interfaces.md), [docs/design/biz-skill-pack-threat-model.md](design/biz-skill-pack-threat-model.md), [SECURITY.md](../SECURITY.md) (root, biz section)
...
|---|---|---|---|---|---|---|
| 1 | `/slo-legal` v1 + shared `references/biz/` wedge (triage-gate, JPP Law cost baseline, oneNDA verbatim) | `done` | 2026-04-25 | 2026-04-25 | [docs/lessons/biz-a-m1.md](lessons/biz-a-m1.md) | [docs/completion/biz-a-m1.md](completion/biz-a-m1.md) |
| 2 | `/slo-accounting` + remainder of M2-tier shared refs (artifact-schema, jurisdiction-uk, ico-duaa-index, ico-enforcement-reality, open-template-anchors) | `done` | 2026-04-25 | 2026-04-25 | [docs/lessons/biz-a-m2.md](lessons/biz-a-m2.md) | [docs/completion/biz-a-m2.md](completion/biz-a-m2.md) |
| 3 | `/slo-equity` + `references/biz/hmrc-vcm-index.md` (VCM34080 / VCM3000 / VCM31000) | `done` | 2026-04-25 | 2026-04-25 | [docs/lessons/biz-a-m3.md](lessons/biz-a-m3.md) | [docs/completion/biz-a-m3.md](completion/biz-a-m3.md) |
| 4 | `/slo-fundraise` + `references/biz/ir35-cest-factors.md` + cross-skill citation test | `done` | 2026-04-25 | 2026-04-25 | [docs/lessons/biz-a-m4.md](lessons/biz-a-m4.md) | [docs/completion/biz-a-m4.md](completion/biz-a-m4.md) |

<!-- Status values: not_started | in_progress | blocked | done -->
<!-- Lessons files go in docs/lessons/biz-a-m<N>.md -->
<!-- Completion summaries go in docs/completion/biz-a-m<N>.md -->

---

## End-to-End Architecture Diagram

See [docs/design/biz-skill-pack-overview.md](design/biz-skill-pack-overview.md) for the full diagram with legend. Summary view below; solid = exists today, dashed = added by this runbook (Runbook A); dotted = added by Runbooks B + C (out of this runbook's scope).
...
1. Read the lessons file from the previous milestone (`docs/lessons/biz-a-m<N-1>.md`), if one exists.
2. Read the current milestone fully.
3. Read the relevant existing reference files (`docs/design/biz-skill-pack-{overview,interfaces,threat-model}.md`, `references/biz/<files-from-prior-milestones>`).
...
8. Create the manual smoke-test stub file (`docs/verify/biz-a-m<N>-smoke.md`) with the empty checklist.
...
12. Write `docs/lessons/biz-a-m<N>.md`.
13. Write `docs/completion/biz-a-m<N>.md`.
...
See the End-to-End Architecture Diagram above and [docs/design/biz-skill-pack-overview.md](design/biz-skill-pack-overview.md).
...
- **NEW: `docs/verify/biz-a-m1-smoke.md`** (M1) — manual smoke-test checklist for M1.
...
- **Abuse case** — REQUIRED in every milestone introducing a new surface (M1 introduces three: `/slo-legal` skill, `references/biz/` directory, biz artifact write to `docs/biz/`). See the milestone-specific abuse-case rows; each cites `tm-biz-abuse-N` from `docs/design/biz-skill-pack-threat-model.md`.
...
| Manual smoke-test checklist | `biz-a-m<N>-smoke.md` | `docs/verify/` |
...
| Smoke-test checklist created | `docs/verify/biz-a-m<N>-smoke.md` | exists with empty checkboxes | | | |
...
| Smoke tests | manual fixture invocation per `docs/verify/biz-a-m<N>-smoke.md` | all checked | | | |
...
| Field | Value |
|---|---|
| Inputs | The locked design decisions in `docs/design/biz-skill-pack-{overview,stack-decision,interfaces,threat-model}.md`; the canonical oneNDA template at https://www.onenda.org/ (downloaded once at M1 implementation time and saved as `references/biz/templates/onenda-uk.md`); JPP Law fixed-fee public pricing at https://www.jpplaw.co.uk/sectors/fixed-fee-startup/ (retrieved 2026-04-25). |
| Outputs | New skill: `skills/slo-legal/SKILL.md`. New shared references: `references/biz/triage-gate.md`, `references/biz/cost-baseline-jpp-law-2026.md`, `references/biz/templates/onenda-uk.md`. New structural-contract test: `crates/sldo-install/tests/e2e_biz_a_m1.rs`. New manual smoke-test checklist: `docs/verify/biz-a-m1-smoke.md`. Optional: `crates/sldo-install/Cargo.toml` dev-dependencies addition for `sha2` if not present. |
...
1. Read `docs/design/biz-skill-pack-overview.md` end-to-end. Confirm understanding of the four locked decisions: GDPR broad hard-block, JPP Law cost baseline, UK only v1, oneNDA verbatim.
2. Read `docs/design/biz-skill-pack-interfaces.md` — internalise the advisor mode contract, the predicate-id schema, and the frontmatter contract.
3. Read `docs/design/biz-skill-pack-threat-model.md` rows tm-biz-abuse-1 through tm-biz-abuse-3 and tm-biz-abuse-7 (these are the M1 abuse cases).
...
5. Read `docs/RUNBOOK-SLO-SECURITY-EMBEDDING.md` Milestone 1 — copy the `e2e_slo_sec_m1.rs` test structure as the precedent for `e2e_biz_a_m1.rs`.
...
10. **Manual smoke test** — invoke `/slo-legal` against the four fixtures from step 7 in a real Claude Code session; tick checkboxes in `docs/verify/biz-a-m1-smoke.md`; record any deviations as Evidence Log notes.
...
Documented in `docs/verify/biz-a-m1-smoke.md`. Manual invocation in a real Claude Code session against four fixtures:
...
| Smoke-test checklist created | `docs/verify/biz-a-m1-smoke.md` | exists with 4 unchecked checkboxes | | | |
...
- [ ] Two test/verification files created: `crates/sldo-install/tests/e2e_biz_a_m1.rs`, `docs/verify/biz-a-m1-smoke.md`.
...
- [ ] All four manual smoke-test scenarios in `docs/verify/biz-a-m1-smoke.md` are ticked.
...
- [ ] `docs/lessons/biz-a-m1.md` and `docs/completion/biz-a-m1.md` written.
...
| `docs/lessons/biz-a-m<N>.md` | NEW | NEW | NEW | NEW | one per milestone |
| `docs/completion/biz-a-m<N>.md` | NEW | NEW | NEW | NEW | one per milestone |
| `docs/design/biz-skill-pack-overview.md` | no edit | no edit | no edit | no edit | already locked by `/slo-architect` |
...
| Files allowed to change | `skills/slo-accounting/SKILL.md` (NEW); `references/biz/artifact-schema.md` (NEW); `references/biz/jurisdiction-uk.md` (NEW); `references/biz/ico-duaa-index.md` (NEW); `references/biz/ico-enforcement-reality.md` (NEW); `references/biz/open-template-anchors.md` (NEW); `crates/sldo-install/tests/e2e_biz_a_m2.rs` (NEW); `docs/verify/biz-a-m2-smoke.md` (NEW); `docs/ARCHITECTURE.md` (one-line addition naming `/slo-accounting` + the five new references); this runbook's Milestone Tracker + Evidence Log rows. |
| Files to read before changing anything | `skills/slo-legal/SKILL.md` (M1 advisor-pattern precedent — copy structure, swap domain); `references/biz/triage-gate.md` (predicate-id schema; do NOT edit, only cite); `references/biz/cost-baseline-jpp-law-2026.md` (cost-line schema; M2 may reference accounting-relevant lines from JPP Law's pricing if available); `docs/design/biz-skill-pack-{overview,interfaces,threat-model}.md` (locked design); `docs/research/biz-skill-pack/dossier.md` Q2 (ICO enforcement reality data — feeds `ico-enforcement-reality.md`); `docs/research/biz-skill-pack/sources.md` (cite source URLs with retrieval dates); `crates/sldo-install/tests/e2e_biz_a_m1.rs` (M1 test precedent — copy structure for structural-contract tests); `docs/verify/biz-a-m1-smoke.md` (smoke-test format precedent). |
| New files allowed | `skills/slo-accounting/SKILL.md`; `references/biz/artifact-schema.md`; `references/biz/jurisdiction-uk.md`; `references/biz/ico-duaa-index.md`; `references/biz/ico-enforcement-reality.md`; `references/biz/open-template-anchors.md`; `crates/sldo-install/tests/e2e_biz_a_m2.rs`; `docs/verify/biz-a-m2-smoke.md`. No new directories — `references/biz/` already exists from M1. |
...
- No changes to `skills/slo-verify/SKILL.md` — the PII-pattern scan integration into `/slo-verify` Pass 4 is deferred from M1's earlier promise to **Runbook B1 M1** (`/slo-talk-to-users`), where the first PII-shaped generator artifacts land. M2 ships the schema (`artifact-schema.md`) that defines what to scan; the runtime integration follows when there's a real artifact to scan against. Document this deferral in `docs/lessons/biz-a-m2.md`.
...
2. Read `docs/lessons/biz-a-m1.md` (M1's lessons file). Note any structural deviations or surprises from M1 that affect M2's authoring.
...
5. Read `docs/research/biz-skill-pack/dossier.md` Q2 (ICO enforcement reality, DUAA 2025) — this is the source for `ico-duaa-index.md` and `ico-enforcement-reality.md`. Cite source URLs with retrieval-date stamps.
...
9. **Author `docs/verify/biz-a-m2-smoke.md`.** Empty checklist with four manual smoke-test items per the description in the Files table above.
...
12. **Manual smoke test** — invoke `/slo-accounting` against the four fixtures from step 9 in a real Claude Code session; tick checkboxes in `docs/verify/biz-a-m2-smoke.md`; record any deviations as Evidence Log notes.
...
Documented in `docs/verify/biz-a-m2-smoke.md`. Manual invocation in a real Claude Code session against four fixtures:
...
| Smoke-test checklist created | `docs/verify/biz-a-m2-smoke.md` | exists with 4 unchecked checkboxes | | | |
...
- [ ] Two test/verification files created: `crates/sldo-install/tests/e2e_biz_a_m2.rs`, `docs/verify/biz-a-m2-smoke.md`.
...
- [ ] All four manual smoke-test scenarios in `docs/verify/biz-a-m2-smoke.md` are ticked.
...
- [ ] `docs/lessons/biz-a-m2.md` written, including explicit note on the deferred `/slo-verify` PII-pattern scan integration to Runbook B1 M1.
- [ ] `docs/completion/biz-a-m2.md` written.
...
**Files (NEW)**: `skills/slo-equity/SKILL.md`, `references/biz/hmrc-vcm-index.md`, `crates/sldo-install/tests/e2e_biz_a_m3.rs`, `docs/verify/biz-a-m3-smoke.md`.
...
**Files (NEW)**: `skills/slo-fundraise/SKILL.md`, `references/biz/ir35-cest-factors.md`, `crates/sldo-install/tests/e2e_biz_a_m4.rs`, `docs/verify/biz-a-m4-smoke.md`.
